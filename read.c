...
int get_lsm(short *array,double*add,double*scale){
	...
	/* Error handling. */
	   ...
	   if ((retval = nc_inq_varid(ncid, "lsm" , &varid)))
	      ERR(retval);
           *add=0.0; retval = nc_get_att_double(ncid, varid, "add_offset", add);
           *scale=1.0; retval = nc_get_att_double(ncid, varid, "scale_factor", scale);
...
int get_era5_hour(int year,int month,int day,int hour,struct meteoday meteo){
	...
	if (month>9){
	   ...
	   if ((retval = nc_inq_varid(ncid, "tcw" , &varid)))
	      ERR(retval);
           *meteo.pwadd=0.0; retval = nc_get_att_double(ncid, varid, "add_offset", meteo.pwadd);
           *meteo.pwscale=1.0; retval = nc_get_att_double(ncid, varid, "scale_factor", meteo.pwscale);
	   ...
	   /* eastward water vapour flux: "p71.162" in legacy CDS files, "viwve" in current ones */
	   if (nc_inq_varid(ncid, "p71.162" , &varid))
	      if ((retval = nc_inq_varid(ncid, "viwve" , &varid)))
	         ERR(retval);
           *meteo.efadd=0.0; retval = nc_get_att_double(ncid, varid, "add_offset", meteo.efadd);
           *meteo.efscale=1.0; retval = nc_get_att_double(ncid, varid, "scale_factor", meteo.efscale);

               if ((retval = nc_get_vara_float(ncid, varid, start,count,meteo.ef)))
                   ERR(retval);
	   /* northward water vapour flux: "p72.162" in legacy CDS files, "viwvn" in current ones */
	   if (nc_inq_varid(ncid, "p72.162" , &varid))
	      if ((retval = nc_inq_varid(ncid, "viwvn" , &varid)))
	         ERR(retval);
           *meteo.nfadd=0.0; retval = nc_get_att_double(ncid, varid, "add_offset", meteo.nfadd);
           *meteo.nfscale=1.0; retval = nc_get_att_double(ncid, varid, "scale_factor", meteo.nfscale);
	      ...
	      ERR(retval);
           *meteo.Eadd=0.0; retval = nc_get_att_double(ncid, varid, "add_offset", meteo.Eadd);
           *meteo.Escale=1.0; retval = nc_get_att_double(ncid, varid, "scale_factor", meteo.Escale);
	      ...
	      ERR(retval);
           *meteo.Padd=0.0; retval = nc_get_att_double(ncid, varid, "add_offset", meteo.Padd);
           *meteo.Pscale=1.0; retval = nc_get_att_double(ncid, varid, "scale_factor", meteo.Pscale);
...
int get_era5_3dq(int year,int month,int day,int hour,struct meteoday meteo){
	...
	if (month>9){
	   ...
	   if ((retval = nc_inq_varid(ncid, "q" , &varid)))
	      ERR(retval);
           *meteo.qadd=0.0; retval = nc_get_att_double(ncid, varid, "add_offset", meteo.qadd);
           *meteo.qscale=1.0; retval = nc_get_att_double(ncid, varid, "scale_factor", meteo.qscale);
...
int get_era5_3dt(int year,int month,int day,int hour,struct meteoday meteo){
	...
	if (month>9){
	   ...
	   if ((retval = nc_inq_varid(ncid, "t" , &varid)))
	      ERR(retval);
           *meteo.tadd=0.0; retval = nc_get_att_double(ncid, varid, "add_offset", meteo.tadd);
           *meteo.tscale=1.0; retval = nc_get_att_double(ncid, varid, "scale_factor", meteo.tscale);
...
int get_era5_3dw(int year,int month,int day,int hour,struct meteoday meteo){
	...
	if (month>9){
	   ...
	   if ((retval = nc_inq_varid(ncid, "w" , &varid)))
	      ERR(retval);
           *meteo.wadd=0.0; retval = nc_get_att_double(ncid, varid, "add_offset", meteo.wadd);
           *meteo.wscale=1.0; retval = nc_get_att_double(ncid, varid, "scale_factor", meteo.wscale);
...
int get_era5_3duv(int year,int month,int day,int hour,struct meteoday meteo){
	...
	if (month>9){
	   ...
	   if ((retval = nc_inq_varid(ncid, "v" , &varid)))
	      ERR(retval);
           *meteo.vadd=0.0; retval = nc_get_att_double(ncid, varid, "add_offset", meteo.vadd);
           *meteo.vscale=1.0; retval = nc_get_att_double(ncid, varid, "scale_factor", meteo.vscale);
	   ...
	   if ((retval = nc_inq_varid(ncid, "u" , &varid)))
	      ERR(retval);
           *meteo.uadd=0.0; retval = nc_get_att_double(ncid, varid, "add_offset", meteo.uadd);
           *meteo.uscale=1.0; retval = nc_get_att_double(ncid, varid, "scale_factor", meteo.uscale);
